...
export default async function JewelleryPage({ searchParams }: JewelleryPageProps) {
  const query = await searchParams;
  await connectDB();

  // 6. Build DB Query filter for the main collection grid
  const filterQuery: any = { category: "jewellery" };
  ...
  // Handle dynamic attributes (e.g. attr_material, attr_color)
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background text-foreground font-sans">
      ...
      <main id="jewellery-collection-section" className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full scroll-mt-20">
        <div className="flex items-center justify-between border-b border-border pb-6 mb-8">
          <div>
            <h2 className="text-2xl sm:text-3xl font-serif tracking-wider text-foreground font-bold uppercase">
