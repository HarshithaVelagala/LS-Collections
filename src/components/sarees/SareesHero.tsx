...
export default function SareesHero() {
  const scrollToCollection = () => {
    const el = document.getElementById("saree-collection-section");
    if (el) {
  ...
  return (
    <div className="relative h-[70vh] w-full overflow-hidden bg-[#2C221C] select-none flex items-center justify-center">
      ...
      <div
        ...
        style={{
          backgroundImage: `url(/banners/saree_banner_1.png)`,
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl mx-auto">
        ...
        >
          Handcrafted masterpieces woven in pure silk and precious zari threads. 
          Discover drapes designed for bridal grandeur and timeless luxury.
        </motion.p>
